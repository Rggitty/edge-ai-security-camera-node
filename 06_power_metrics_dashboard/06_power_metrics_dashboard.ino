...
String htmlPage() {
  ...
  page += "button{padding:10px 15px;border:0;border-radius:8px;font-weight:bold;}";
  ...
  page += "<button onclick='resetStats()'>Reset Metrics</button>";
...
void handleReset() {
  resetMetrics();
  server.send(200, "text/plain", "metrics reset");
}
...
void setup() {
  ...
  Serial.println();
  Serial.println("==== EDGE CAMERA POWER METRICS DASHBOARD ====");
